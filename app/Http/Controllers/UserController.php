...
class UserController extends Controller
{
        ...
        // return view('home.home', compact('products', 'product_images', 'categories'));
    return view('home.home', compact('products','count_product','product_images','product_carts','categories'));
        }
    ...
    public function show($id){
        ...
        return view('home.detail', compact('product', 'images', 'sum_image', 'id', 'product_carts', 'image_carts', 'categories', 'discount','reviews', 'response'));
    }
    ...
    public function invoice($id){
        ...
        return view('home.invoice', compact('transactions'));
    }
    ...
    public function getInvoice($id){
        ...
        return view('home.invoice_detail', compact('transaction', 'products', 'reviews'));
    }
    ...
    public function search_category(Request $request){
        ...
        $count_product = DB::table('products')
                    ...
                    ->count('products.id');
        return view('home.invoice', compact('products', 'product_images', 'categories', 'discounts', 'title', 'count_product'));
    }
    ...
    public function uploadPOP(Request $request, $id){
        ...
        $transaction->save();
        $notif = "<a class='dropdown-item' href='/admin/order/cek/".$transaction->id."' id=''>".
