...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="/admin"><img src="{{asset('assets/admin/images/logo.svg')}}" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="/admin"><img src="{{asset('assets/admin/images/logo-mini.svg')}}" alt="logo"/></a>
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              ...
              <a href="{{ url('/admin/logout') }}" class="dropdown-item"
                  ...
                  document.getElementById('logout-form').submit();">
                    ...
                    <form id="logout-form" action="{{ url('/logout/admin') }}" method="GET" style="display: none;">
                    @csrf
                    </form> 
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="/product-category">Kategori</a></li>
                <li class="nav-item"> <a class="nav-link" href="/courier">Kurir</a></li>
              </ul>
            </div>
          </li>
        </ul>
