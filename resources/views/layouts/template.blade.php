...
<head>
    ...
    <link rel="stylesheet" href="{{asset('icon/path/to/font-awesome/css/font-awesome.min.css')}}">
    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="./blog.html">Invoice</a></li>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="{{route('carts.show', Auth::user()->id)}}">Checkout</a></li>
                            <li><a href="/users/{{Auth::user()->id}}/invoice">Invoice</a>
                                    @if(Auth::check())
                                        <?php 
                                            $id = Auth::user()->id;
                                            $notif_count = DB::table('user_notifications')->where('notifiable_id', $id)->where('read_at',NULL)->count();

                                            $notifications = DB::table('user_notifications')->where('notifiable_id',$id)->where('read_at',NULL)->orderBy('created_at','desc')->get();
                                        ?>
                            </li>

                            <li><a href="">Pesan @if($notif_count != 0)</a>
                                <span class="badge" style="background-color: red;">{{$notif_count}}</span>
                                <ul class="header__menu__dropdown" style="width: 300px;">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            ...
                            <li><a href="{{route('carts.show', Auth::user()->id)}}"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
                        </ul>
                        <div class="header__cart__price">item: <span>$150.00</span></div>
                    </div>
                </div>
