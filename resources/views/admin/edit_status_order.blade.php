                ...
                <div class="component">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-footer">
                            <span><button class="btn btn-md btn-success" type="submit"  onclick="return confirm('Apa yakin ingin mengubah status pembayaran?')" style="margin-right: 20px;">Process</button></span><span><a href="{{ URL::to( '/image/proof_of_payment/'.$transaction->proof_of_payment)  }}" target="_blank" class="btn btn-info">Lihat Bukti Pembayaran</a></span>
                        </div>
                        </form>
                    @if (count($errors) > 0)
